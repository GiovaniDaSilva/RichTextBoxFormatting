        ...
        /*
           ...
           Public Class MotorRichFmt
            ...
            Private LT_Link As Token =
                New Token With
                {.Tag = "A", .ParRequired = True, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(par)
                  End Sub
            }
            ...
            Private LT_Bold As Token =
                New Token With
            {.Tag = "B", .ParRequired = False, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(True)
                  End Sub
            }
            ...
            Private LT_Italic As Token =
                New Token With
            {.Tag = "I", .ParRequired = False, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(True)
                  End Sub
            }
            ...
            Private LT_Underline As Token =
                New Token With
            {.Tag = "U", .ParRequired = False, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(True)
                  End Sub
            }
            ...
            Private LT_Color As Token =
                New Token With
            {.Tag = "FC", .ParRequired = True, .AddMethod =
                  Sub(par As String)
            ...
            Private LT_Size As Token =
                New Token With
            {.Tag = "FS", .ParRequired = True, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(par)
                  End Sub
            }
            ...
            Private LT_Name As Token =
                New Token With
            {.Tag = "FN", .ParRequired = True, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(par)
                  End Sub
            }
            ...
            Private LT_Backgound As Token =
                New Token With
            {.Tag = "BC", .ParRequired = True, .AddMethod =
                  Sub(par As String)
                      .Lst.Add(Color.FromName(par))
                  End Sub
            }
